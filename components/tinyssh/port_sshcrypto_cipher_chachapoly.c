...
int chachapoly_packet_get(struct buf *b) {
    ...
    printf("DEBUG: chachapoly_packet_get: packet_length=%u, PACKET_LIMIT=%u, receivepacketid=%u\n", 
           (unsigned int)packet.packet_length, (unsigned int)PACKET_LIMIT, (unsigned int)packet.receivepacketid);
    fflush(stdout);
